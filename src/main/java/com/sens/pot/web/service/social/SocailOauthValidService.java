...
import com.sens.pot.web.service.social.impl.FacebookOauthValidService;

public interface SocailOauthValidService {
      /**
    ...
    //     if (this instanceof FacebookOauthValidService) {
